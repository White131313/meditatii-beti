            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative z-10">
                        ...
                        <h1 className="text-3xl sm:text-4xl lg:text-7xl font-black text-gray-900 tracking-tight leading-[1.1] mb-6 lg:mb-8">
                        ...
                        <p className="text-base sm:text-lg lg:text-xl text-gray-600 mb-8 lg:mb-10 leading-relaxed max-w-xl">
                            {currentT.subtitle}
                        </p>
                        ...
                        <div className="flex flex-wrap gap-4 mb-8 lg:mb-12">
                            <button
                                ...
                                className="group relative px-6 sm:px-8 py-3 sm:py-4 bg-gray-900 text-white rounded-2xl font-bold text-base sm:text-lg hover:bg-brand-600 transition-all duration-300 shadow-2xl shadow-gray-200 hover:shadow-brand-500/40 flex items-center gap-2 overflow-hidden"
                            >
                                <span className="relative z-10">{currentT.seeMaterials}</span>
                        ...
                        {/* Trust Badges */}
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 py-4 sm:py-6 border-t border-gray-100">
